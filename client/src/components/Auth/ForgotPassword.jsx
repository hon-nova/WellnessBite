...
const ForgotPassword = () => {
   ...
   const [errors,setErrors]=useState({email:"",password:"",confirm_password:"",errorBackend:""})
...
const handleRecoverPassword = (e)=>{
  ...
  return (
    ...
    {success && (
     ...
     Enter your registered <b>email</b><br/>
     <input type="email" 
      name="email"
     ...
     <button type="submit">Recover Password</button></form>
    </div>
  )
}
